...
<table>
    ...
    <tr>
     ...
     <tr>
        ...
        <tr>
        <td width="100px">code</td> <td width="100px">必填</td> <td width="200px">服务类型和编码（0204为空间处理服务，中间以@@@分隔，前面为服务名称WPS）</td>
    </tr>
        <tr>
...
<table>
   ...
   **WPS服务特有配置信息,配置服务协议信息。**
<table>
    <tr>
        <td width="250px">名称</td> <td width="120px">是否可选</td> <td width="400px">描述</td>
    </tr>
     <tr>
        <td width="250px">WPS.WPS.ENABLE</td> <td width="120px">必填</td> <td width="100px">WPS服务协议（默认值true）</td>
    </tr>
