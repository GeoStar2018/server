    ...
    "service": {
        "serviceInfo": {
            ...
            "settings": {
                ...
                "TMS.TMS.MAXWIDTH": "",
                "ADDR": "",
                "PATH": "C:\\Users\\administrator\\Desktop\\专题图\\2D扇形.GMAPX",
                "PWD": "1",
                "REMOUTE": "1",
                "USR": "admin" 
            },
...
<table>
    <tr>
        ...
        <tr>
        <td width="100px">code</td> <td width="100px">必填</td> <td width="200px">服务类型和编码（0239为专题图服务，中间以@@@分隔，前面为服务名称TMS）</td>
    </tr>
    <tr>
...
<table>
   ...
   >TMS服务特有配置信息,配置服务协议信息。
<table>
    <tr>
        <td width="250px">名称</td> <td width="120px">是否可选</td> <td width="400px">描述</td>
    </tr>
     <tr>
        <td width="250px">TMS.TMS.ENABLE</td> <td width="120px">必填</td> <td width="100px">TMS服务协议（默认值true）</td>
    </tr>              
      <tr>
        <td width="250px">TMS.TMS.MAXHEIGHT</td> <td width="120px">选填</td> <td width="400px">图片高度</td>
    </tr>
      <tr>
        <td width="250px">TMS.TMS.MAXWIDTH</td> <td width="120px">选填</td> <td width="400px">图片宽度</td>
    </tr>
      <tr>
